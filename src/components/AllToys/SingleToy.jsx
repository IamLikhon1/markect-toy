...
const SingleToy = () => {
    ...
    const{picture,name,email,sellerName,price,rating,quantity,description}=singleData
    return (
     ...
     data-aos-duration="1000">
                ...
                <figure><img className="md:w-96" src={picture} alt="Toy Picture"/></figure>
                <div className="card-body rounded-2xl hover:bg-sky-300">
                    ...
                    <p className="mt-2 font-medium font-serif">Seller Email: {email}</p>
